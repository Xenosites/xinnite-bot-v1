...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, wm.trim(), await( await conn.getFile(thumbnail)).data, [['Video', `.ytv ${vid.url}`]], false, { quoted: m, 'document': { 'url':'https://wa.me/+6281911317205' },
...
sourceUrl: 'http://wa.me/+6281911317205', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
